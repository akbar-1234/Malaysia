(function () {
  ...
  (t = window.jQuery || window.Zepto || window.$),
    ...
    (p = function (t) {
      var e, n, r, a, o, i;
      for (
        r = !0, a = 0, n = (t + "").split("").reverse(), o = 0, i = n.length;
        i > o;
        o++
      )
        (e = n[o]),
    ...
    (h = function (t) {
      var e;
      return null != t.prop("selectionStart") &&
      ...
      return (
        ...
        null !== r && e.is(":focus")
          ? (r === i.length && (r = t.length),
            i !== t &&
              ((l = i.slice(r - 1, +r + 1 || 9e9)),
              (n = t.slice(r - 1, +r + 1 || 9e9)),
              (a = t[r]),
              /\d/.test(a) && l === "" + a + " " && n === " " + a && (r += 1)),
    ...
    (m = function (t) {
      ...
      for (
        ...
        (n = e[l]), (o = r.indexOf(n)), o > -1 && (n = a[o]), (i += n);
      return i;
    }),
    (d = function (e) {
      var n;
    ...
    (C = function (n) {
      ...
      return (
        ...
        (o = String.fromCharCode(n.which)),
        /^\d+$/.test(o) && !h(r)
          ? ((i = (r.val() + o).replace(/\D/g, "")),
            (a = e(i)),
            a ? i.length <= a.length[a.length.length - 1] : i.length <= 16)
          : void 0
      );
    }),
    (T = function (e) {
    ...
    (y = function (e) {
      ...
      return (
        (n = t(e.currentTarget)),
        (r = String.fromCharCode(e.which)),
        /^\d+$/.test(r) && !h(n) ? ((a = n.val() + r), a.length <= 4) : void 0
      );
    }),
    (D = function (e) {
      var n, a, o, i, l;
      return (
        (n = t(e.currentTarget)),
        (l = n.val()),
        (i = t.payment.cardType(l) || "unknown"),
        n.hasClass(i)
          ? void 0
          : ((a = (function () {
              var t, e, n;
      ...
      return (
        ...
        /^\d+$/.test(t)
          ? ((n = e(t)),
            n
              ? ((r = t.length),
                k.call(n.length, r) >= 0 && (n.luhn === !1 || p(t)))
              : !1)
          : !1
      );
    }),
    (t.payment.validateCardExpiry = function (e, n) {
      ...
      return (
        "object" == typeof e &&
          "month" in e &&
          ((o = e), (e = o.month), (n = o.year)),
        e && n
          ? ((e = t.trim(e)),
            (n = t.trim(n)),
            /^\d+$/.test(e) && /^\d+$/.test(n) && e >= 1 && 12 >= e
              ? (2 === n.length && (n = 70 > n ? "20" + n : "19" + n),
                4 !== n.length
                  ? !1
                  : ((a = new Date(n, e)),
                    (r = new Date()),
    ...
    (t.payment.validateCardCVC = function (e, r) {
      ...
      return (
        ...
        /^\d+$/.test(e)
          ? ((a = n(r)),
            null != a
              ? ((o = e.length), k.call(a.cvcLength, o) >= 0)

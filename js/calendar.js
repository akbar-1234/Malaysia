...
function pasport1(dayOfWeek, i, year, month) {
  ...
  localStorage.setItem('select_data', `${weeks}, ${monthName} ${i}, ${year}`);
...
if (localStorage.getItem("for_year")) {
  localStorage.setItem('select_data', `${weekDayName}, ${monthName} ${dayNumber}, ${localStorage.getItem("for_year")}`);
}else{
  localStorage.setItem('select_data', `${weekDayName}, ${monthName} ${dayNumber}, ${year}`);
}
...
localStorage.setItem("select_data",`${week1}, ${month1} ${day1}, ${year1}`)

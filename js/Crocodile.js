...
document.addEventListener("DOMContentLoaded", () => {
  const translations = {
    english: {
      ...
      bookCrocodile: "Book Crocodile Adventureland Langkawi Tickets",
    ...
    indonesian: {
      ...
      bookCrocodile: "Pesan Tiket Crocodile Adventureland Langkawi",
    ...
    malasia: {
      ...
      comboTwelve: "Tiket ke Kebun Binatang G2G",
      comboSixTeen:
        "Combo (Hemat 16%): KL Tower Observation Deck + Tiket KLIA Ekspress",
      comboSevn: "Combo (Hemat 17%):Tiket Menara KL + Menara Kembar Petronas",
      ...
      bookbird_ticket_1_description_1:
        "Lupakan barisan panjang dan terus ke Aquaria KLCC di Kuala Lumpur, yang tersenarai antara lima akuarium terbaik di Asia.",
      bookbird_ticket_1_description_2:
        "Berlalu sehingga 90 permainan dan tarikan, termasuk Vuvuzela, salah satu permainan air tertinggi di dunia, Tomahawk yang terbalik, dan banyak lagi.",
      bookbird_ticket_1_description_3:
        "Akuarium canggih mereka benar-benar menjadikannya pengalaman yang luar biasa untuk orang dewasa dan kanak-kanak.",
      bookbird_ticket_1_description_4:
        "Nikmati akses percuma ke Taman Malam, yang menawarkan tarikan, aktiviti dalam suasana bertema Barat Amerika Lama, dan pertunjukan api.",
      bookbird_ticket_1_description_5:
        "Tingkatkan pengalaman anda dengan akses keutamaan pilihan ke 21 permainan, atau pilih pas 2 hari dengan makanan, perkhemahan, dan diskaun pada permainan berbayar.",
      bookbird_ticket_1_skidka: "Diskaun 6%",
      bookbird_from: "dari",
      bookbird_check: "Semak ketersediaan",
      next_available: "Seterusnya tersedia: Hari ini",
      mobile_ticket: "Tiket mudah alih",
      flexible_duration: "Tempoh Fleksibel",
      meals_included: "Makanan Disertakan",
      kuala_lumpur: "Kuala Lumpur",
      petronas_twin: "Tiket Petronas Twin Towers",
      top_things: "Perkara terbaik yang perlu dilakukan di Kuala Lumpur",
      kl_tower: "Tiket KL Tower",
      petronas_twin: "Tiket Petronas Twin Towers",
      ...
      kuala_lumpur2: "Taman Burung Kuala Lumpur",
      kidzana_kuala: "Tiket Kidzania Kuala Lumpur",
      kl_tower2: "Mini Zoo KL Tower",
      visiting_petronas:
        "Melawat Petronas Twin Towers | Tiket dan lawatan diterangkan",
      smack_in:
        "Tepat di tengah-tengah Kuala Lumpur, Menara Petronas Twin berdiri tinggi sebagai simbol seni bina moden. Menara ini, yang mempunyai 88 tingkat, SkyBridge dan Deck Pemerhatian, adalah tempat yang mesti dilawat bagi sesiapa yang mahu melihat pemandangan indah Kuala Lumpur yang luas. Dengan tiket anda, anda akan dapat melawat tarikan di dalam menara, seperti Petrosains, Pusat Penemuan dan Aquaria KLCC. Baca lebih lanjut untuk mengetahui mengapa anda perlu mendapatkan Tiket Menara Petronas Twin semasa lawatan anda ke Kuala Lumpur!",
      skip_the: "Tiket Laluan Cepat",
      breeze_through:
        "Lalui barisan dengan mudah dan dapatkan akses laluan cepat ke Menara Petronas Twin yang megah, menjulang tinggi di atas langit Kuala Lumpur",
      ewalk_across:
        "Berjalan di atas SkyBridge kaca terkenal di tingkat 41 dan 42, jambatan 2-tingkat tertinggi di dunia.",
      take_an:
        "Naik lif ke Deck Pemerhatian di tingkat 86 dan nikmati pemandangan menakjubkan bandar.",
      enange_with:
        "Berkaitan dengan pelbagai paparan digital dan pameran yang tersebar di seluruh menara kembar.",
      recommended_E:
        "Pengalaman Disyorkan: <br> Tiket Kemasukan Standard ke Menara Petronas Twin",
      combo_tickets: "Tiket Combo",
      get_a_holi:
        "Dapatkan lawatan holistik ke tarikan menarik di Kuala Lumpur dengan menggabungkan tawaran dan tarikan dalam satu tiket!",
      get_up:
        "Dapatkan diskaun sehingga 12% pada tiket anda dengan tarikan tertentu seperti KLIA Ekspres, dan manfaatkan wang dan masa anda semasa perjalanan ke Malaysia. Dapatkan diskaun lanjut pada tiket untuk warga emas dan kanak-kanak.",
      visit_landmarks:
        "Lawati mercu tanda di Malaysia seperti Batu Caves, KLIA Ekspres dan banyak lagi, dan pilih lawatan berpandu peribadi atau lawatan hop-on, hop-off dengan tiket combo anda. Pengalaman Disyorkan: <br> Combo (Jimat 12%): Tiket Menara Petronas Twin + KLIA Ekspres Tiket <br> Deck Pemerhatian KL Tower + Sky Deck + Sky Box + Tower Walk 100 + Tiket Laluan Cepat ke Menara Petronas Twin",
      what_youll: "Apa yang anda akan lihat di Menara Petronas Twin",
      theres_lots:
        "Ada banyak perkara yang boleh anda lakukan semasa melawat Menara Petronas Twin! Cari Skybridge yang terkenal di dunia, salah satu deck pemerhatian tertinggi di Malaysia, dan Aquaria KLCC serta Petrosains yang terkenal!",
      observation_deck: "Deck Pemerhatian",
      if_its:
        "Jika ini adalah kali pertama anda melawat Menara Petronas Twin, Deck Pemerhatian di Tingkat 83 adalah tempat yang sesuai! Berdiri dengan kagum di hadapan Menara Petronas Twin yang ikonik, pengunjung akan menikmati pengalaman tiada tandingan sambil melihat pemandangan bandar dengan seni bina moden.",
      skybridge: "Skybridge",
      connecting_the:
        "Menghubungkan dua menara ikonik di tingkat 41 dan 42, jambatan bertingkat dua ini membolehkan anda melihat pemandangan panorama bandar yang menakjubkan. Anda juga akan mendapat pemandangan indah bandar yang sibuk di bawah, dengan skyline yang mengagumkan di hadapan anda.",
      observation_deck2: "Kedai Hadiah Deck Pemerhatian",
      grab_a_postcard:
        "Dapatkan poskad, gantungan kunci, baju-T, atau cenderahati lain untuk merakam intipati mercu tanda terkenal ini. Kedai Hadiah Deck Pemerhatian adalah sebuah harta, membolehkan anda membawa pulang kenangan lawatan anda ke Menara Petronas Twin.",
      petrosains_the: "Petrosains, Pusat Penemuan",
      petrosains_is:
        "Petrosains adalah destinasi yang mesti dikunjungi bagi mereka yang mencari pengalaman interaktif dan pendidikan. Temui ruang angkasa, selami kedalaman lautan, dan terlibat dengan pelbagai pameran yang menjadikan pembelajaran mengenai sains seronok dan menarik.",
      aquaria_KLCC2: "Aquaria KLCC",
      aquaria_KLCC3:
        "Aquaria KLCC adalah akuarium bertaraf dunia dengan saiz sekitar 60,000 kaki persegi dan menempatkan lebih daripada 5,000 organisma akuatik dan marin. Pelbagai paparan seperti Lautan Hidup, Aliran, Pantai, dan Laut Dalam membolehkan pengunjung menyelami persekitaran bawah air.",
      fine_dining: "Restoran Mewah",
      choose_from:
        "Pilih dari pelbagai restoran mewah di Menara Petronas Twin, di tingkat 51 dan 52. Tingkat ini menempatkan restoran dari negara-negara seperti Jepun, China, pelbagai makanan mewah Malaysia, dan masakan Eropah yang mewah seperti Itali dan Portugis. Anda akan dapat merasai pelbagai jenis masakan di samping pemandangan dan pemandangan yang menakjubkan.",
      plan_your_visit: "Rancang lawatan anda ke Menara Petronas Twin",
      learn_everything:
        "Ketahui segala yang anda perlu tahu mengenai lawatan anda ke Menara Petronas Twin dalam seksyen ini! Dari waktu operasi, restoran di dalam menara, peraturan dan panduan – rancang lawatan yang sempurna ke menara.",
      timings: "Waktu Operasi",
      getting_there: "Cara Ke Sana",
      facilities: "Kemudahan",
      nearby: "Sekitar",
      when_are:
        "Bilakah Menara Petronas Twin dibuka? Waktu operasi Menara Petronas Twin adalah dari 10 pagi hingga 6 petang. Menara ditutup pada hari Isnin. (Kecuali pada Cuti Umum atau Cuti Pengganti untuk cuti yang jatuh pada hari Isnin)",
      best_time:
        "Waktu Terbaik untuk Melawat: Waktu terbaik untuk melawat menara adalah pada waktu petang, antara 5 hingga 6 petang, kerana anda mungkin dapat menyaksikan pertunjukan air dan cahaya pada waktu ini. Selain itu, setiap malam dari 8 malam hingga 10 malam, Lake Symphony di KLCC mengadakan pertunjukan simfoni dan cahaya.",
      weekdays_vs_weekends:
        "Hari Biasa vs Hujung Minggu: Kami mengesyorkan melawat Menara Petronas pada hari biasa, kerana hujung minggu mungkin agak sesak.",
      address: "Alamat",
      sunway_lagoon:
        "Sunway Lagoon, Sunway Pyramid, 3, Bandar Sunway, Jalan PJS 11/11, 46150 Petaling Jaya, Selangor, Malaysia.",
      by_car:
        "Dengan Kereta: Dengan lebuh raya ekspres yang cepat, Sunway Lagoon hanya 15 minit perjalanan dari Kuala Lumpur. Anda boleh memasukkan lokasi taman dan navigasi akan membawa anda ke destinasi anda.",
      by_train:
        "Dengan Kereta Api: Naik kereta api KTM Komuter ke Stesen Subang Jaya atau kereta api Putra LRT ke stesen Kelana Jaya, kemudian bas pengangkut Sunway Pyramid ke taman. Sebagai alternatif, anda boleh naik kereta api dari Stesen Kelana Jaya dan menaiki bas pengangkut ke hentian Pyramid.",
      by_bus:
        "Dengan Bas: Hentian bas Sunway Pyramid adalah hentian bas terdekat dengan taman dan hanya 4 minit berjalan kaki.",
      by_shuttle:
        "Dengan Perkhidmatan Pengangkutan: Perkhidmatan pengangkutan percuma disediakan oleh Sunway di sekitar bandar setiap 25 minit. Ia beroperasi antara 7 pagi hingga 9:30 malam dari Isnin hingga Jumaat, dan antara 9 pagi hingga 9:30 malam pada hujung minggu dan cuti umum.",
      WiFi: "WiFi: Terdapat WiFi percuma di Sunway Lagoon",
      wheelchair:
        "Akses kerusi roda: Taman ini kebanyakannya boleh diakses dengan kerusi roda. Mereka juga mempunyai tandas yang boleh diakses.",
      parking:
        "Tempat Letak Kereta: Tempat letak kereta tersedia di Sunway Pyramid Shopping Mall & Sunway Resort Hotel & Spa.",
      Lockers:
        "Loker: Anda boleh menyimpan barang-barang anda di loker semasa melawat taman. Anda boleh mendapatkan loker untuk slot masa tertentu.",
      Washrooms:
        "Tandas: Terdapat tandas di mana anda boleh menukar selepas menaiki permainan kolam air.",
      First_Aid:
        "Pertolongan Cemas: Terdapat hospital swasta yang terletak berhampiran taman untuk sebarang kecemasan perubatan.",
      Park_Map:
        "Peta Taman: Terdapat peta taman yang tersedia untuk memastikan anda tidak sesat di taman. Muat turun peta di sini.",
      sunway_pyramid_shopping: "Sunway Pyramid Shopping Mall",
      while_there:
      ...
      Address2:
        "Alamat: Jalan 3, Jalan PJS 11/15, Bandar Sunway, 47500 Petaling Jaya, Selangor, Malaysia",
      there_is_also:
        "Terdapat juga kedai dalam talian oleh Sunway Lagoon di mana anda boleh mencari barangan penting taman serta beberapa cenderamata.",
      you_need:
        "Anda memerlukan lebih banyak tenaga apabila anda berseronok! Kafe yang tersebar di seluruh taman tema boleh memuaskan keinginan anda untuk minuman penyegar, makanan ringan, sesuatu yang ringan, atau hidangan penuh.",
      Hydration_Zone:
        "Zona Penghidratan: Kekal terhidrat semasa lawatan anda dan puasakan dahaga anda dengan pelbagai minuman penyegar yang tersedia di Zona Penghidratan.",
      Take_5:
        "Ambil 5 dan segarkan diri anda dengan jus tembikai segar di Take 5. Anda juga boleh makan makanan ringan seperti popcorn, minuman ringan dan hot dog yang lazat.",
      hot_roll:
        "Hot & Roll: Dengan pelbagai pembalut manis dan gurih, Hot & Roll termasuk pelbagai pembalut yang datang dalam pelbagai roti seperti chapattis, parathas atau bahkan pita.",
      you_can_stay:
        "Anda boleh menginap di beberapa hotel berhampiran taman semasa anda melawat Sunway Lagoon.",
      Budget: "Bajet: Hotel Sunway Pyramid",
      Mid_Range: "Julat Pertengahan: Hotel Sunway Clio, Sunway Pyramid Mall",
      Luxury: "Kedudukan Mewah: Luxury Resort Suites, Sunway City",
      legoland: "Legoland Malaysia",
      if_youre:
        "Jika anda masih berminat dengan taman tema, Legoland Malaysia adalah tempat yang hebat untuk berseronok. Dengan lebih daripada lapan bahagian bertema dengan lebih 40 aktiviti dan tarikan, Legoland Malaysia pasti merupakan tempat yang mesti dikunjungi.",
      habitat: "Habitat Penang Hill",
      deep_dive:
        "Selam ke dalam pelukan alam semula jadi di Habitat Penang Hill, pusat penemuan hutan hujan yang megah, yang merupakan tempat yang sempurna untuk semua peminat alam.",
      entopia: "Entopia oleh Penang Butterfly Farm",
      get_closer:
        "Dekatkan diri anda dengan alam semula jadi dengan bilik darjah yang terbuat daripada alam di Entopia. Dengan lebih 300 spesies flora dan fauna, nikmati aktiviti pembelajaran dan berinteraksi dengan haiwan untuk mempelajari lebih lanjut tentang alam semula jadi yang menakjubkan.",
    },
  };
